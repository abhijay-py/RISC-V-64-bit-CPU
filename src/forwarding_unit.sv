...
module forwarding_unit (
  ...
  always_comb begin: FORWARD_ONE
    ...
    if (fuif.opcode_de inside {LUI, JAL, AUIPC}) begin
      ...
      if (fuif.RegWrite_em && !fuif.MemRead_em && fuif.rd_em != '0 && fuif.rd_em == fuif.rs1_de)
        fuif.forward_one = 2'b01;
      else if (fuif.RegWrite_mw && fuif.rd_mw != '0 && fuif.rd_mw == fuif.rs1_de)
        fuif.forward_one = 2'b10;

      if (fuif.RegWrite_em && !fuif.MemRead_em && fuif.rd_em != '0 && fuif.rd_em == fuif.rs2_de)
        fuif.forward_two = 2'b01;
      else if (fuif.RegWrite_mw && fuif.rd_mw != '0 && fuif.rd_mw == fuif.rs2_de)
