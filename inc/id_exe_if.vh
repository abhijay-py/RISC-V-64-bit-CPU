...
interface id_exe_if;
    ...
    addr_t pc_id, pc_exe, jumpimm_id, jumpimm_exe;
    reg_t rd_id, rs2_id, rs1_id, rd_exe, rs2_exe, rs1_exe;
    dword_t rdata1_id, rdata2_id, rdata1_exe, rdata2_exe, imm_id, imm_exe;
    ...
    modport de (
        ...
        input  pc_id, rd_id, rs2_id, rs1_id, rdata1_id, rdata2_id, imm_id, jumpimm_id, ALUOp_id, MemData_id, funct3_id, prev_ghr_id, opcode_id,
        ...
        output rd_exe, rs2_exe, rs1_exe, rdata1_exe, rdata2_exe, imm_exe, jumpimm_exe, pc_exe, ALUOp_exe, MemData_exe, opcode_exe, funct3_exe, prev_ghr_exe
    );
    ...
    modport tb (
        ...
        input   rd_exe, rs2_exe, rs1_exe, rdata1_exe, rdata2_exe, imm_exe, jumpimm_exe, pc_exe, ALUOp_exe, MemData_exe, opcode_exe, funct3_exe, prev_ghr_exe,
        ...
        output  pc_id, rd_id, rs2_id, rs1_id, rdata1_id, rdata2_id, imm_id, jumpimm_id, ALUOp_id, MemData_id, funct3_id, prev_ghr_id
    );
